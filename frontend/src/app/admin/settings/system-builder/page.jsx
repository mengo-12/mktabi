...
export default function SystemBuilderPage() {
    ...
    return (
        <div className=" min-h-screen bg-slate-100 dark:bg-zinc-950 transition-colors duration-300 " dir="rtl">

            <div className="mx-auto max-w-[1800px] p-8">

                {/* Header */}

                <div className="mb-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">

                    <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between px-8 py-8">
                        ...
                        ">
                            ...
                            <div>
                                ...
                                dark:text-white
                            ">
                                    مصنع ومطور النظام القانوني والمكتبي
                                </h1>
                                ...
                                dark:text-zinc-400
                            ">
                                    قم ببناء الصفحات والجداول والحقول والقوالب القانونية
                                    وتصميم المستندات المرئية من مكان واحد.
                                </p>
                ...
                {activeTab === "engine" && (
                    <div className="grid grid-cols-1 gap-8 xl:grid-cols-12">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                إدارة الأقسام والجداول التابعة لها.
                                            </p>
                                ...
                                <div className="p-7">
                                    ...
                                    <div className="mb-6 flex gap-3">
                                        ...
                                        <input
                                            ...
                                            className="flex-1 rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:focus:ring-cyan-900/40"
                                        />

                                        <button
                                            onClick={handleCreateSection}
                                            className="rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 px-5 py-3 font-semibold text-white shadow-lg transition hover:scale-[1.02]"
                                        >
                                            إضافة
                                        </button>
                                    ...
                                    <div className="space-y-3 max-h-60 overflow-y-auto pr-2">
                                        {sections.map((sec) => (
                                            <div key={sec.id} onClick={() => { setSelectedSectionId(sec.id); setEditingSectionTitle(sec.title); }} className={`flex items-center justify-between rounded-2xl border px-4 py-4 cursor-pointer transition-all ${selectedSectionId === sec.id ? "border-cyan-500 bg-cyan-50 dark:bg-cyan-900/20" : "border-slate-200 bg-slate-50 hover:border-cyan-300 hover:bg-white dark:border-zinc-700 dark:bg-zinc-800"}`}>
                                                {editingSectionId === sec.id ? (
                                                    <div className="flex gap-1 items-center w-full" onClick={(e) => e.stopPropagation()}>
                                                        <input type="text" value={editingSectionTitle} onChange={(e) => setEditingSectionTitle(e.target.value)} className="bg-zinc-900 border border-zinc-700 rounded px-1.5 py-0.5 text-xs text-zinc-100" />
                                                        <button onClick={() => handleUpdateSection(sec.id)} className="bg-green-600 text-white text-[10px] p-1 rounded">حفظ</button>
                                                        ...
                                                        <div className="flex gap-2 items-center" onClick={(e) => e.stopPropagation()}>
                                                            <div className="flex gap-2">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="rounded-lg p-2 text-cyan-600 transition hover:bg-cyan-100 dark:hover:bg-cyan-900/30"
                                                                >
                                                                    ✏️
                                                                </button>
                                        ...
                                        <div className="mt-5 border-t border-zinc-800 pt-4">
                                            <div className="mb-4 flex items-center justify-between">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="mt-1 text-xs text-slate-500 dark:text-zinc-400">
                                                        ...
                                                        جميع الجداول الموجودة داخل هذا القسم.

                                                    </p>

                                                </div>

                                                <span className="rounded-xl bg-cyan-50 px-3 py-1 text-xs font-semibold text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300">

                                                    {(sections.find(s => s.id === selectedSectionId)?.tables || []).length}
                                            ...
                                            <div className="space-y-3 max-h-72 overflow-y-auto">
                                                ...
                                                {(sections.find(s => s.id === selectedSectionId)?.tables || []).map((table) => (
                                                    ...
                                                    <div
                                                        key={table.id}
                                                        className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition-all hover:border-cyan-300 hover:bg-white dark:border-zinc-700 dark:bg-zinc-800"
                                                    >

                                                        <div className="flex items-center gap-3">

                                                            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-blue-100 text-lg dark:bg-blue-900/30">
                                                ...
                                                {(sections.find(s => s.id === selectedSectionId)?.tables || []).length === 0 && (

                                                    <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 py-12 text-center dark:border-zinc-700 dark:bg-zinc-800">
                                                        ...
                                                        <h4 className="mt-4 text-lg font-semibold text-slate-700 dark:text-white">
                        ...
                        {/* 2. هندسة وبناء جداول المحرك الديناميكي */}
                        <div className="xl:col-span-9 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all dark:border-zinc-800 dark:bg-zinc-900">
                            <div className="border-b border-slate-200 px-7 py-6 dark:border-zinc-800">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                            ...
                                            أنشئ الجداول والحقول والعلاقات وإعدادات النظام الديناميكي.

                                        </p>

                                    </div>

                                    <div className="rounded-xl bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300">
                            ...
                            <div className="space-y-8 p-7">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                        ...
                                        الاسم الأساسي للجدول وطريقة عرضه داخل النظام.
                                ...
                                <div className="grid gap-6 lg:grid-cols-2">
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            placeholder="مثال: القضايا"
                                            value={tableName}
                                            onChange={(e) => setTableName(e.target.value)}
                                            className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:focus:ring-cyan-900/30"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:focus:ring-cyan-900/30"
                                        >
                                            <option value="table">🖥️ عرض جدولي</option>
                                ...
                                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 dark:border-zinc-800 dark:bg-zinc-800/40">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                ...
                                                اختر الحقل الذي سيمثل السجل في العلاقات والتقارير وحقول البحث.
                                    ...
                                    <div className="mt-5 rounded-2xl border border-cyan-200 bg-cyan-50 px-5 py-4 dark:border-cyan-800 dark:bg-cyan-900/20">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-cyan-700 dark:text-cyan-400">
                                                    ...
                                                    سيتم استخدام هذا الحقل تلقائيًا عند عرض السجلات داخل
                                                    العلاقات، والتقارير، وحقول البحث، والتقويم، والقوائم
                                                    المنسدلة.
                                ...
                                <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                                    ...
                                    <div className="border-b border-slate-200 px-7 py-6 dark:border-zinc-800">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                    إدارة اعتماد جدول الموظفين وربطه بنظام تسجيل الدخول والصلاحيات.
                                                </p>
                                    ...
                                    <div className="p-7">
                                        ...
                                        <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 dark:border-zinc-800 dark:bg-zinc-800/40">
                                            ...
                                            <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-900">

                                                <label
                                                    htmlFor="isStaffTable"
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        ...
                                                        <h4 className="font-semibold text-slate-800 dark:text-white">
                                                            ...
                                                            اعتماد كجدول الموظفين

                                                        </h4>

                                                        <p className="mt-2 text-sm leading-6 text-slate-500 dark:text-zinc-400">

                                                            عند تفعيل هذا الخيار سيتم استخدام بيانات هذا الجدول
                                                            لإنشاء حسابات المستخدمين، وتسجيل الدخول،
                                                            والصلاحيات، وربط الموظفين بجميع أجزاء النظام.
                                                    ...
                                                    <input
                                                        ...
                                                        checked={isStaffTable}
                                                        onChange={(e) =>
                                                            setIsStaffTable(e.target.checked)
                                                        }
                                                        className="mt-1 h-5 w-5 rounded border-slate-300 text-cyan-600 focus:ring-cyan-500 dark:border-zinc-600"
                                                    />
                                            ...
                                            <div className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 dark:border-amber-800 dark:bg-amber-900/20">
                                                ...
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="mt-1 text-sm text-amber-700 dark:text-amber-400">
                                                            ...
                                                            يجب أن يحتوي هذا الجدول على الحقول المطلوبة مثل
                                                            البريد الإلكتروني أو اسم المستخدم وكلمة المرور
                                                            والصلاحيات حتى يتمكن النظام من استخدامه
                                                            كقاعدة بيانات للمستخدمين.
                                ...
                                <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                    ...
                                                    أضف الحقول، وحدد أنواعها، والعلاقات، والقيم الافتراضية، والصلاحيات.
                                    ...
                                    <div className="p-7">
                                        ...
                                        <div className="space-y-4 mb-6 max-h-[75vh] overflow-y-auto pr-2">
                                            {columns.map((col, index) => (
                                                <div
                                                    key={col.id}
                                                    className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900"
                                                >

                                                    <div className="border-b border-slate-200 bg-slate-50 px-6 py-5 dark:border-zinc-800 dark:bg-zinc-800/40">
                                                        ...
                                                        <div className="flex items-start justify-between">
                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <button
                                                                    type="button"
                                                                    onClick={() => handleRemoveColumnField(col.id)}
                                                                    className="flex h-10 w-10 items-center justify-center rounded-xl border border-red-200 bg-red-50 text-red-600 transition-all hover:scale-105 hover:bg-red-100 dark:border-red-800 dark:bg-red-900/20 dark:text-red-400"
                                                                    title="حذف الحقل"
                                                                >
                                                                    🗑️
                                                                </button>
                                                    ...
                                                    <div className="space-y-6 p-6">
                                                        ...
                                                        <div className="mt-6 rounded-2xl border border-cyan-200 bg-cyan-50 px-5 py-4 dark:border-cyan-800 dark:bg-cyan-900/20">
                                                            ...
                                                            <div className="flex items-start gap-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="mt-1 text-sm text-cyan-700 dark:text-cyan-400">
                                                                        ...
                                                                        عند اختيار نوع <strong>تاريخ</strong> يمكن استخدام هذا الحقل
                                                                        لإنشاء أحداث التقويم وربطه بالجدول تلقائيًا.
                                                    ...
                                                    <label className="flex items-center gap-2 text-xs">
                                                        ...
                                                        <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-50 p-6 dark:border-zinc-700 dark:bg-zinc-800/40">

                                                            <div className="mb-5 flex items-start gap-4">

                                                                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 to-fuchsia-600 text-xl text-white shadow-lg">
                                                                    ✨
                                                                </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                        سيتم تعبئة هذه القيمة تلقائيًا عند إنشاء سجل جديد إذا لم يقم المستخدم بإدخال قيمة.
                                                                    </p>
                                                            ...
                                                            <div className="mt-4 rounded-2xl border border-violet-200 bg-violet-50 px-4 py-3 dark:border-violet-800 dark:bg-violet-900/20">

                                                                <p className="text-sm text-violet-700 dark:text-violet-300">
                                                                    💡 إذا تُرك هذا الحقل فارغًا فلن يتم تعيين أي قيمة تلقائية.
                                                                </p>
                                                        ...
                                                        {col.type === "dropdown" && (
                                                            ...
                                                            <div className="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                                                                ...
                                                                <div className="border-b border-slate-200 px-6 py-5 dark:border-zinc-700">
                                                                    ...
                                                                    <div className="flex items-center justify-between">
                                                                        ...
                                                                        <div className="flex items-center gap-4">
                                                                            ...
                                                                            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-green-600 text-xl text-white shadow-lg">
                                                                                📝
                                                                            </div>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                    أضف أو عدّل الخيارات التي سيتمكن المستخدم من اختيارها.
                                                                                </p>
                                                                        ...
                                                                        <button
                                                                            type="button"
                                                                            onClick={() => addDropdownOption(index)}
                                                                            className="rounded-2xl bg-gradient-to-r from-cyan-600 to-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition hover:scale-[1.02]"
                                                                        >
                                                                            + إضافة خيار
                                                                        </button>
                                                                ...
                                                                <div className="space-y-4 p-6">
                                                                    ...
                                                                    {col.options.length === 0 ? (
                                                                        ...
                                                                        <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 py-10 text-center dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                            ...
                                                                            <p className="mt-2 text-sm text-slate-500 dark:text-zinc-400">
                                                                                اضغط على "إضافة خيار" لإنشاء أول عنصر.
                                                                            </p>
                                                                        ...
                                                                        col.options.map((option, optIndex) => (
                                                                            ...
                                                                            <div
                                                                                key={optIndex}
                                                                                className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:border-cyan-300 hover:bg-cyan-50 dark:border-zinc-700 dark:bg-zinc-800/40 dark:hover:border-cyan-700"
                                                                            >

                                                                                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300">
                                                                                    {optIndex + 1}
                                                                                </div>
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    className="flex-1 rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:focus:ring-cyan-900/30"
                                                                                />
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    className="flex h-11 w-11 items-center justify-center rounded-2xl border border-red-200 bg-red-50 text-lg text-red-600 transition hover:bg-red-100 dark:border-red-800 dark:bg-red-900/20 dark:text-red-400"
                                                                                >
                                                                                    🗑️
                                                                                </button>
                                                                ...
                                                                <div className="border-t border-slate-200 bg-slate-50 px-6 py-4 dark:border-zinc-700 dark:bg-zinc-800/40">

                                                                    <p className="text-sm text-slate-500 dark:text-zinc-400">
                                                                        💡 ستظهر هذه الخيارات للمستخدم داخل القائمة المنسدلة فقط.
                                                                    </p>
                                                            ...
                                                            <div className="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                                                                ...
                                                                <div className="border-b border-slate-200 px-6 py-5 dark:border-zinc-700">
                                                                    ...
                                                                    <div className="flex items-center gap-4">
                                                                        ...
                                                                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 to-indigo-600 text-xl text-white shadow-lg">
                                                                            🔗
                                                                        </div>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <h4 className="text-base font-bold text-slate-900 dark:text-white">
                                                                                ربط الجداول (Relation)
                                                                            </h4>

                                                                            <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                اربط هذا الحقل بجدول آخر داخل النظام لإنشاء علاقة ديناميكية.
                                                                            </p>
                                                                ...
                                                                <div className="space-y-6 p-6">
                                                                    ...
                                                                    <div className="rounded-2xl border border-violet-200 bg-violet-50 p-5 dark:border-violet-800 dark:bg-violet-900/20">
                                                                        ...
                                                                        <div className="flex items-start gap-3">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <h5 className="font-semibold text-violet-700 dark:text-violet-300">
                                                                                    معاينة العلاقة
                                                                                </h5>

                                                                                <p className="mt-2 text-sm leading-6 text-violet-600 dark:text-violet-400">

                                                                                    {getRelationTableId(col)
                                                                                        ? `سيعرض هذا الحقل بيانات من جدول ${allAvailableTables.find(
                                                                                            (t) => t.id == getRelationTableId(col)
                                                                                        )?.name || "الجدول المحدد"
                                                                                        }.`
                                                                                        : "اختر جدولاً لإنشاء علاقة بين السجلات."}
                                                            ...
                                                            <div className="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                                                                ...
                                                                <div className="border-b border-slate-200 px-6 py-5 dark:border-zinc-700">
                                                                    ...
                                                                    <div className="flex items-center gap-4">
                                                                        ...
                                                                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 text-xl text-white shadow-lg">
                                                                            🔐
                                                                        </div>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                حدد صلاحيات الحساب الجديد لكل جدول داخل النظام.
                                                                            </p>
                                                                ...
                                                                <div className="grid gap-4 p-6">
                                                                    ...
                                                                    {allAvailableTables.length === 0 ? (
                                                                        ...
                                                                        <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 py-10 text-center dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                            ...
                                                                            <p className="mt-2 text-sm text-slate-500 dark:text-zinc-400">
                                                                                قم بإنشاء جداول أولاً ثم عد لإدارة الصلاحيات.
                                                                            </p>
                                                                        ...
                                                                        allAvailableTables.map((table) => (
                                                                            ...
                                                                            <div
                                                                                key={table.id}
                                                                                className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 p-5 transition hover:border-cyan-300 hover:bg-cyan-50 dark:border-zinc-700 dark:bg-zinc-800/40"
                                                                            >
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                        الصلاحية الافتراضية لهذا الجدول.
                                                                                    </p>
                                                                                ...
                                                                                <select
                                                                                    value={
                                                                                        (col.default_permissions &&
                                                                                            col.default_permissions[table.id]) ||
                                                                                        "no_access"
                                                                                    }
                                                                                    onChange={(e) =>
                                                                                    ...
                                                                                    className="rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-800 outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:focus:ring-cyan-900/30"
                                                                                >
                                                                ...
                                                                <div className="border-t border-slate-200 bg-slate-50 px-6 py-4 dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                    ...
                                                                    <p className="text-sm text-slate-500 dark:text-zinc-400">
                                                                        💡 سيتم تطبيق هذه الصلاحيات تلقائيًا عند إنشاء مستخدم جديد من هذا النوع.
                                                                    </p>
                                    ...
                                    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                        ...
                                                        اربط هذا الجدول بالتقويم وحدد كيفية ظهور الأحداث.
                                        ...
                                        <div className="p-7">
                                            ...
                                            <div className="mt-8  border-zinc-800 pt-6">
                                                ...
                                                {dateFields.length === 0 ? (
                                                    ...
                                                    <div className="mt-10 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                                                        ...
                                                        <div className="space-y-8 p-8">
                                                            ...
                                                            <div className="space-y-5">
                                                                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                    ...
                                                                    <div className="flex items-center justify-between">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <p className="mt-2 text-sm text-slate-500 dark:text-zinc-400">
                                                                                ...
                                                                                عند التفعيل سيتم إنشاء أحداث تلقائياً من سجلات هذا الجدول.
                                                                        ...
                                                                        <label className="relative inline-flex cursor-pointer items-center">
                                                                            ...
                                                                            <div className="h-7 w-12 rounded-full bg-slate-300 transition peer-checked:bg-cyan-600 dark:bg-zinc-700"></div>
                                                                    ...
                                                                    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                                                                        ...
                                                                        <div className="border-b border-slate-200 px-6 py-5 dark:border-zinc-700">
                                                                            ...
                                                                            <div className="flex items-center gap-4">
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                        اختر الحقول التي سيستخدمها التقويم لإنشاء الحدث.
                                                                                    </p>
                                                                        ...
                                                                        <div className="grid gap-6 p-6 md:grid-cols-2">
                                                                            ...
                                                                            <div className="border-t border-slate-200 bg-slate-50 px-6 py-4 dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                                ...
                                                                                <p className="text-sm text-slate-500 dark:text-zinc-400">
                                                                                    ...
                                                                                    💡 سيتم استخدام هذه الحقول تلقائياً لإنشاء أحداث التقويم عند إضافة أو تعديل السجلات.
                                                                            ...
                                                                            <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                                                                                ...
                                                                                <div className="border-b border-slate-200 px-6 py-5 dark:border-zinc-700">
                                                                                    ...
                                                                                    <div className="flex items-center gap-4">
                                                                                        ...
                                                                                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-pink-500 to-orange-500 text-xl text-white shadow-lg">
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                                ...
                                                                                                اختر لون الأحداث والأيقونة التي ستظهر داخل التقويم.
                                                                                ...
                                                                                <div className="space-y-8 p-6">
                                                                                    ...
                                                                                    <div className="mt-4 flex flex-wrap gap-4">
                                                                                        ...
                                                                                        {presetColors.map((color) => (
                                                                                            ...
                                                                                            <button
                                                                                                ...
                                                                                                className={`relative h-12 w-12 rounded-2xl transition-all duration-300 ${calendarMapping.color === color
                                                                                                    ? "scale-110 ring-4 ring-cyan-300 dark:ring-cyan-700"
                                                                                                    : "hover:scale-105"
                                                                                                    }`}
                                                                                                style={{
                                                                                                    backgroundColor: color
                                                                                    ...
                                                                                    <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4 dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                                        ...
                                                                                        <input
                                                                                            ...
                                                                                            className="h-12 w-16 cursor-pointer rounded-2xl border border-slate-300 bg-white dark:border-zinc-700 dark:bg-zinc-900"
                                                                                        />
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    className="mt-3 w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:focus:ring-cyan-900/30"
                                                                                >
                                                                                    <option value="calendar">📅 جلسة</option>
                                                                                    <option value="scale">⚖️ قضية</option>
                                                                                    <option value="file">📄 عقد</option>
                                                                        ...
                                                                        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                                                                            ...
                                                                            <div className="border-b border-slate-200 px-6 py-5 dark:border-zinc-700">
                                                                                ...
                                                                                <div className="flex items-center gap-4">
                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                            تحكم في طريقة تعامل التقويم مع أحداث هذا الجدول.
                                                                                        </p>
                                                                            ...
                                                                            <div className="space-y-5 p-6">
                                                                                ...
                                                                                <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4 dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <div className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                            سيتم عرض الحدث بدون وقت بداية ونهاية.
                                                                                        </div>
                                                                                ...
                                                                                <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-5 py-4 dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <div className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                                                            يمكن للمستخدمين تغيير موعد الحدث مباشرة من التقويم.
                                                                                        </div>
                                                                                ...
                                                                                <div className="flex justify-end border-t border-slate-200 pt-6 dark:border-zinc-700">

                                                                                    <button
                                                                                        type="button"
                                                                                        onClick={() => setIsEventPreviewOpen(true)}
                                                                                        className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-600 to-blue-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:scale-[1.02]"
                                                                                    >
                                                                                        👁
                                                                                        معاينة الحدث
                                                                                    </button>
                                                                            ...
                                                                            <div className="border-t border-slate-200 bg-slate-50 px-6 py-4 dark:border-zinc-700 dark:bg-zinc-800/40">
                                                                                ...
                                                                                <p className="text-sm text-slate-500 dark:text-zinc-400">
                                                                                    يمكنك تعديل هذه الخيارات لاحقًا في أي وقت دون التأثير على البيانات الحالية.
                                                                                </p>
                                    ...
                                    {isEventPreviewOpen && (
                                        ...
                                        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm">
                                            ...
                                            <div className="w-full max-w-2xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_25px_80px_rgba(0,0,0,.35)] dark:border-zinc-700 dark:bg-zinc-900">

                                                {/* Header */}

                                                <div className="border-b border-slate-200 px-8 py-7 dark:border-zinc-700">
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="mt-2 text-sm text-slate-500 dark:text-zinc-400">
                                                                    هكذا سيظهر الحدث داخل التقويم بعد حفظ الإعدادات.
                                                                </p>
                                                        ...
                                                        <button
                                                            onClick={() => setIsEventPreviewOpen(false)}
                                                            className="flex h-11 w-11 items-center justify-center rounded-xl border border-slate-300 bg-white text-slate-500 transition hover:bg-slate-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
                                                        >
                                                            ✕
                                                        </button>
                                                ...
                                                <div className="space-y-6 bg-slate-50 p-8 dark:bg-zinc-950">

                                                    <div
                                                        className="overflow-hidden rounded-3xl border bg-white shadow-sm dark:bg-zinc-900"
                                                        style={{
                                                            borderColor: calendarMapping.color
                                                        }}
                                                    >
                                                        ...
                                                        <div className="space-y-5 p-6 text-slate-700 dark:text-zinc-200">
                                                            ...
                                                            {previewDescription && (
                                                                ...
                                                                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 dark:border-zinc-700 dark:bg-zinc-800/40">
                                                ...
                                                <div className="flex items-center justify-between border-t border-slate-200 bg-slate-50 px-8 py-5 dark:border-zinc-700 dark:bg-zinc-800/40">

                                                    <span className="text-sm text-slate-500 dark:text-zinc-400">
                                                        هذه مجرد معاينة قبل حفظ إعدادات التقويم.
                                                    </span>

                                                    <button
                                                        onClick={() => setIsEventPreviewOpen(false)}
                                                        className="rounded-xl border border-slate-300 bg-white px-6 py-2.5 font-medium text-slate-700 transition hover:bg-slate-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:hover:bg-zinc-800"
                                                    >
                                                        إغلاق
                                                    </button>
                                    ...
                                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                ...
                                                سيتم حفظ جميع الحقول والإعدادات وربطها بالجدول الحالي.
                                        ...
                                        <div className="flex flex-wrap items-center gap-3">
                                            ...
                                            <button
                                                ...
                                                className="inline-flex items-center gap-2 rounded-2xl border border-slate-300 bg-white px-5 py-3 font-medium text-slate-700 transition hover:bg-slate-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800"
                                            >
                        ...
                        {/* <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all dark:border-zinc-800 dark:bg-zinc-900">
                            ...
                            <div className="border-b border-slate-200 px-7 py-6 dark:border-zinc-800">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 to-fuchsia-600 text-white shadow-lg">
                                    ...
                                    <div>
                                        ...
                                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">
                                            ...
                                            مصمم القوالب القانونية

                                        </h2>

                                        <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">

                                            أنشئ العقود والمذكرات والقوالب الديناميكية بسهولة.
                        ...
                        {/* <div className="mb-6 flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                ...
                                                حدد اسم القالب ونوعه قبل البدء في كتابة المحتوى.
                        ...
                        {/* <div className="grid gap-5 lg:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder="مثال: عقد تقديم خدمات قانونية"
                                                className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:focus:ring-cyan-900/30"
                                            />
                        ...
                        {/* <div className="mb-6 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                    ...
                                                    أضف المتغيرات التي يمكن استخدامها داخل القالب.
                                        ...
                                        <div className="rounded-xl bg-emerald-100 px-4 py-2 text-sm font-semibold text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300">
                        ...
                        {/* <div className="grid gap-4 lg:grid-cols-[1fr_1fr_auto]">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-800 outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white dark:focus:ring-emerald-900/30"
                                            />
                                        ...
                                        <div className="flex items-end">
                                            ...
                                            <button
                                                ...
                                                className="inline-flex h-[50px] items-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 px-6 font-semibold text-white shadow-lg transition hover:scale-[1.02]"
                                            >
                        ...
                        {/* <div className="mt-8">
                                        ...
                                        <div className="mb-3 text-sm font-semibold text-slate-700 dark:text-zinc-300">
                                        ...
                                        {variables.length === 0 ? (
                                            ...
                                            <div className="rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-8 text-center text-slate-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-500">

                                                لا توجد متغيرات حتى الآن.
                                            ...
                                            <div className="flex flex-wrap gap-3">
                                                ...
                                                {variables.map((v, idx) => (
                                                    ...
                                                    <div
                                                        key={idx}
                                                        className="flex items-center gap-2 rounded-2xl border border-emerald-200 bg-white px-4 py-2 shadow-sm transition hover:shadow-md dark:border-emerald-800 dark:bg-zinc-900"
                                                    >
                                                        ...
                                                        <span className="rounded-lg bg-slate-100 px-2 py-1 font-mono text-xs text-slate-600 dark:bg-zinc-800 dark:text-zinc-400">
                                ...
                                <div className="overflow-hidden rounded-3xl border border-slate-200 bg-slate-50 dark:border-zinc-700 dark:bg-zinc-800/40"> */}

                        {/* Header */}

                        {/* <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5 dark:border-zinc-700">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                                    ...
                                                    اكتب محتوى العقد أو المذكرة واستخدم المتغيرات الديناميكية.
                        ...
                        {/* <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 bg-white px-6 py-3 dark:border-zinc-700 dark:bg-zinc-900">

                                        <button
                                            type="button"
                                            className="rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm transition hover:bg-slate-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700"
                                        >
                                            B
                                        </button>
                                        ...
                                        <button
                                            type="button"
                                            className="rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm italic transition hover:bg-slate-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700"
                                        >
                                            I
                                        </button>
                                        ...
                                        <div className="ml-auto text-xs text-slate-500 dark:text-zinc-400">
                        ...
                        {/* <div className="p-6">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="ابدأ بكتابة محتوى العقد أو المذكرة هنا..."
                                            className="min-h-[450px] w-full resize-y rounded-2xl border border-slate-300 bg-white p-5 font-mono text-[14px] leading-8 text-slate-800 outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:ring-cyan-900/30"
                                        />
                        ...
                        {/* <div className="mt-8 flex flex-col gap-5 border-t border-slate-200 pt-6 dark:border-zinc-700 lg:flex-row lg:items-center lg:justify-between"> */}
                        ...
                        {/* <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">
                                        ...
                                        سيتم حفظ القالب والمتغيرات وربطه بالمحرك الديناميكي.
                        ...
                        {/* <div className="flex flex-wrap items-center gap-3">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 px-6 py-3 font-semibold text-white shadow-lg transition hover:scale-[1.02]"
                                    >
